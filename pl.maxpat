{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 148.0, 44.0, 850.0, 811.0 ],
		"bglocked" : 0,
		"defrect" : [ 148.0, 44.0, 850.0, 811.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "t b i",
					"patching_rect" : [ 540.0, 380.0, 34.5, 20.0 ],
					"outlettype" : [ "bang", "int" ],
					"id" : "obj-46",
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "t b i",
					"patching_rect" : [ 500.0, 380.0, 32.5, 20.0 ],
					"outlettype" : [ "bang", "int" ],
					"id" : "obj-34",
					"fontname" : "Futura Medium",
					"fontsize" : 10.0,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "unpack 0 0",
					"patching_rect" : [ 500.0, 360.0, 60.0, 20.0 ],
					"outlettype" : [ "int", "int" ],
					"id" : "obj-29",
					"fontname" : "Futura Medium",
					"fontsize" : 10.0,
...
, 			{
				"box" : 				{
					"maxclass" : "outlet",
					"patching_rect" : [ 740.0, 330.0, 25.0, 25.0 ],
					"id" : "obj-26",
					"numinlets" : 1,
					"numoutlets" : 0,
					"comment" : "playmode (2 = slicemode)"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 500.0, 340.0, 82.0, 20.0 ],
					"outlettype" : [ "" ],
					"id" : "obj-14",
					"fontname" : "Futura Medium",
					"fontsize" : 10.0,
...
, 			{
				"box" : 				{
					...
					"patcher" : 					{
						"fileversion" : 1,
						"rect" : [ 0.0, 377.0, 452.0, 336.0 ],
						"bglocked" : 0,
						"defrect" : [ 0.0, 377.0, 452.0, 336.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 0,
						"default_fontsize" : 10.0,
						"default_fontface" : 0,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "sel 1",
					"patching_rect" : [ 550.0, 580.0, 38.5, 20.0 ],
					"outlettype" : [ "bang", "" ],
					"id" : "obj-11",
					"fontname" : "Futura Medium",
					"fontsize" : 10.0,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : ">~ 0.985",
					"patching_rect" : [ 590.0, 580.0, 55.0, 20.0 ],
					"outlettype" : [ "signal" ],
					"id" : "obj-8",
					"fontname" : "Futura Medium",
					"fontsize" : 10.0,
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-7", 0 ],
					"hidden" : 0,
					"midpoints" : [ 139.5, 520.0, 469.5, 520.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-7", 0 ],
					"hidden" : 0,
					"midpoints" : [ 279.5, 520.0, 469.5, 520.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-7", 0 ],
					"hidden" : 0,
					"midpoints" : [ 399.5, 520.0, 469.5, 520.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 449.5, 390.0, 469.5, 390.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-6", 0 ],
					"hidden" : 0,
					"midpoints" : [ 670.5, 335.0, 449.5, 335.0 ]
				}
